							...
							<div class="row">
								...
								if(!isset($_POST['search'])){
										...
										<li class="col-md-4 col-sm-6 mb-xl center isotope-item <?php echo $sonuc[9];?> <?php echo $sonuc[5];?> ">
											...
											<p class="mb-none">Tarih: <?php $date = new DateTime($sonuc[2]); echo $date->format('d.m.Y');?></p>
											...
											include_once("data/baglanti.php");
											$search=$_POST['search'];
											$sql="SELECT * FROM `etkinlikler` WHERE CONCAT(ad,kategori,il,ilce,adres,aciklama) LIKE '%$search%'";
											$sorgu=mysqli_query($baglan,$sql);
										...
										echo $_POST['search'] ." İle ilgili bir sonuç bulunamadı...";
									}
