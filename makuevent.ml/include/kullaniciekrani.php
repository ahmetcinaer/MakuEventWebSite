...
<div class="container" style="padding: 2% 0% 2% 10%;margin-top: -8%;">
	...
	<div class="row" style=" background-size: 800px 800px ;width: 800px;height: 800px; margin-top: 10%; border-radius: 15px; padding: 5%; display: inline-block; box-shadow: 10px 10px 10px #000; background-color: #361c6c;text-align:center ;" >
			...
			<div class="col-md-8" style="width: 300px;height: 300px; margin-top: 5%;">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                	...
                	<form <?php if (isset($_GET['edit'])){echo 'action="data/bilgiguncelle.php?id=';echo $id ;echo'" method="POST"';}
...
<?php include_once("data/baglanti.php");
...
<td style="width: 80px;"><span style="background: gray ;width: 50px;height: 25px;float: right; margin-left: -50%;"><a style="color:#fff" href="data/etkinliksil.php?etkid=<?php echo $sonuc[0]; ?>">Sil</a></span></td>
