							...
							<div class="blog-posts single-post mt-xl">
								...
								<article class="post post-large blog-single-post">
									...
									while( $sonuc=mysqli_fetch_row($sorgu)){?>
										...
										<img src="<?php echo $sonuc[5];?>" class="img-responsive pull-left mb-xs mr-xl" alt="" style="width: 360px; height: 510px;">
									  ...
									  echo $date->format('d.m.Y'); echo " | "; echo substr($sonuc[3], 0, 5) ; ?>
												...
												<li>
													<div class="comment" >
														<div class="img-thumbnail" style=" margin-top:10px ;" >
															<img class="avatar" alt="" width="80px" height="80px" src="img/avatar.jpg">
														</div>
										...
										<div class="post-block post-leave-comment pb-none">
											...
											<form action='include/yorumekle.php?etkinlikid=<?php echo $etkinlikid;echo "'" ;?>' method="POST">
												<div class="row">
